...
export type PullGithubRepositoriesMutation = { __typename?: 'Mutation', pullGithubRepositories: { __typename?: 'GithubPullResult', jobId: number, status: Status, repos: Array<{ __typename?: 'GithubRepository', id: number, name: string, description?: string | null, html_url: string, clone_url: string, language?: string | null, platform: string, url: string }> } };
...
export type ResumeGithubPullMutation = { __typename?: 'Mutation', resumeGithubPull: { __typename?: 'GithubPullResult', jobId: number, status: Status, repos: Array<{ __typename?: 'GithubRepository', id: number, name: string, description?: string | null, html_url: string, clone_url: string, language?: string | null, platform: string, url: string }> } };
